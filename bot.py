...
# قیمت‌های ثابت هر دسته به ازای هر اسکین
PRICES = {
    'Supreme': 1200000,
    'Grand': 500000,
    'Exquisite': 300000
...
# توضیحات هر دسته اسکین
EXPLANATIONS = {
    'Supreme': "✅ این دسته شامل اسکین‌های لجند می‌باشد.\n\nچندتا اسکین از این دسته داری؟",
    'Grand': (
        "✅ این دسته شامل اسکین‌های کوف، جوجوتسو، سوپر هیرو، استاروارز، ناروتو، ابیس و... می‌باشد."
    ...
    'Exquisite': (
        "✅ این دسته شامل اسکین‌های کالکتور، لاکی باکس و کلادز می‌باشد(اسکین های پرایم در این قسمت وارد کنید).\n\n"
...
# ------------------- وب‌سرور فلاسک برای جلوگیری از خاموش شدن (مثلا روی Heroku) -------------------
